 ...
 * @LastEditTime: 2022-12-08 14:49:54
...
function thumb_dplayer(mouseenter_e, box_e) {
    ...
    function video_thumb_play() {
        ...
        if (!_this.find('.dplayer-thumb').length) {
            ...
            var dplayer = $('<div class="dplayer-thumb-hide new-dplayer dplayer-thumb controller-hide' + (scale_height ? ' dplayer-scale-height' : '') + '"' + (scale_height ? ' style="--scale-height:' + scale_height + '%;"' : '') + ' data-loop="true" data-volume="none" data-hide="true" video-url="' + video_url + '" video-pic="' + video_pic + '" video-type="auto"></div>');
